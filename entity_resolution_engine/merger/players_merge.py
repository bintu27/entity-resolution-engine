...
def merge_players(
    ...
    for match in matches:
        ...
        ues_id = generate_ues_id("UESP", match["alpha_player_id"], match["beta_player_id"])
        ...
        canonical_nationality = normalize_country(alpha_row.get("nationality") or beta_row.get("nationality"))
        ...
        records.append(
            {
                ...
                "foot": canonical_foot.lower() if isinstance(canonical_foot, str) else canonical_foot,
